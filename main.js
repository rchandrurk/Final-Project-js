...
function navSlide() {
  ...
  function showSlides(n) {
    let i;
    let slides = document.getElementsByIdName("mySlides");
    let dots = document.getElementByIdName("dot");
    ...
    for (i = 0; i < dots.length; i++) {
      dots[i].IdName = dots[i].IdName.replace(" active", "");
    }
    slides[slideIndex-1].style.display = "block";  
    dots[slideIndex-1].IdName += " active";
  }